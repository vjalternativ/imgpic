...
class MysqliManager extends MysqlManager
{
	...
	public function connect(array $configOptions = null, $dieOnError = false)
	{
		...
		if(!isset($this->database)) {
			...
			$this->database = @mysqli_connect($dbhost,$configOptions['db_user_name'],$configOptions['db_password'],isset($configOptions['db_name'])?$configOptions['db_name']:'',$dbport) or die("failed connection");
	if(empty($this->database)) {
