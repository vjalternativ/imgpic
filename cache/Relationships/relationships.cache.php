 ...
 $relationships = array (
  ...
  array (
    ...
    array (
      ...
      3 => 
      array (
        'name' => 'rc_image_users_1rc_image_ida',
        'type' => 'varchar',
        'len' => 36,
      ),
      4 => 
      array (
        'name' => 'rc_image_users_1users_idb',
        'type' => 'varchar',
        'len' => 36,
      ),
    ),
    ...
    array (
      ...
      1 => 
      array (
        'name' => 'rc_image_users_1_alt',
        'type' => 'alternate_key',
        'fields' => 
        array (
          0 => 'rc_image_users_1rc_image_ida',
          1 => 'rc_image_users_1users_idb',
        ),
      ),
    ),
    'lhs_module' => 'rc_image',
  ...
  array (
    ...
    array (
      ...
      4 => 
      array (
        'name' => 'rc_topic_rc_categoryrc_topic_idb',
        'type' => 'varchar',
        'len' => 36,
      ),
    ),
    ...
    array (
      ...
      1 => 
      array (
        'name' => 'rc_topic_rc_category_ida1',
        'type' => 'index',
        'fields' => 
        array (
          0 => 'rc_topic_rc_categoryrc_category_ida',
        ),
      ),
      2 => 
      array (
        'name' => 'rc_topic_rc_category_alt',
        'type' => 'alternate_key',
        'fields' => 
        array (
          0 => 'rc_topic_rc_categoryrc_topic_idb',
        ),
      ),
    ),
    'lhs_module' => 'rc_category',
  ...
  array (
    'name' => 'rc_category_modified_user',
    'lhs_module' => 'Users',
    'lhs_table' => 'users',
    'lhs_key' => 'id',
    'rhs_module' => 'rc_category',
  ...
  array (
    'name' => 'rc_category_assigned_user',
    'lhs_module' => 'Users',
    'lhs_table' => 'users',
    'lhs_key' => 'id',
    'rhs_module' => 'rc_category',
  ...
  array (
    'name' => 'securitygroups_rc_category',
    'lhs_module' => 'SecurityGroups',
    'lhs_table' => 'securitygroups',
    'lhs_key' => 'id',
    'rhs_module' => 'rc_category',
  ...
  array (
    'name' => 'rc_following_modified_user',
    'lhs_module' => 'Users',
    'lhs_table' => 'users',
    'lhs_key' => 'id',
  ...
  array (
    'name' => 'rc_following_assigned_user',
    'lhs_module' => 'Users',
    'lhs_table' => 'users',
    'lhs_key' => 'id',
    'rhs_module' => 'rc_following',
  ...
  array (
    'name' => 'securitygroups_rc_following',
    'lhs_module' => 'SecurityGroups',
    'lhs_table' => 'securitygroups',
    'lhs_key' => 'id',
    'rhs_module' => 'rc_following',
