...
<tr>
	...
	<td scope="row" nowrap="nowrap" width='1%' >
			<label for='name_basic'> {sugar_translate label='LBL_NAME' module='rc_ads'}
		</td>
...
<input type='text' name='{$fields.name_basic.name}' 
	...
	<td scope="row" nowrap="nowrap" width='1%' >
		...
		<label for='current_user_only_basic' >{sugar_translate label='LBL_CURRENT_USER_FILTER' module='rc_ads'}</label>
    	</td>
...
value="1" title='' tabindex="" {$checked} >
	...
	<td scope="row" nowrap="nowrap" width='1%' >
		...
		<label for='page_basic' >{sugar_translate label='LBL_PAGE' module='rc_ads'}</label>
    	</td>

	
	<td  nowrap="nowrap" width='1%'>
			
{html_options id='page_basic' name='page_basic[]' options=$fields.page_basic.options size="6" style="width: 150px" multiple="1" selected=$fields.page_basic.value}
   	   	</td>
	...
	<td scope="row" nowrap="nowrap" width='1%' >
		...
		<label for='status_basic' >{sugar_translate label='LBL_STATUS' module='rc_ads'}</label>
    	</td>
...
{html_options id='status_basic' name='status_basic[]' options=$fields.status_basic.options size="6" style="width: 150px" multiple="1" selected=$fields.status_basic.value}
	...
	<td scope="row" nowrap="nowrap" width='1%' >
		...
		<label for='position_basic' >{sugar_translate label='LBL_POSITION' module='rc_ads'}</label>
    	</td>

	
	<td  nowrap="nowrap" width='1%'>
			
{html_options id='position_basic' name='position_basic[]' options=$fields.position_basic.options size="6" style="width: 150px" multiple="1" selected=$fields.position_basic.value}
   	   	</td>
