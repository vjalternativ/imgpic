<?php /* Smarty version 2.6.29, created on 2018-01-19 22:27:00
         compiled from cache/modules/rc_ads/SearchForm_basic.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'counter', 'cache/modules/rc_ads/SearchForm_basic.tpl', 33, false),array('function', 'math', 'cache/modules/rc_ads/SearchForm_basic.tpl', 34, false),array('function', 'sugar_translate', 'cache/modules/rc_ads/SearchForm_basic.tpl', 43, false),array('function', 'html_options', 'cache/modules/rc_ads/SearchForm_basic.tpl', 107, false),array('function', 'sugar_getimagepath', 'cache/modules/rc_ads/SearchForm_basic.tpl', 164, false),array('modifier', 'count', 'cache/modules/rc_ads/SearchForm_basic.tpl', 151, false),)), $this); ?>
...
<tr>
	...
	<td scope="row" nowrap="nowrap" width='1%' >
			<label for='name_basic'> <?php echo smarty_function_sugar_translate(array('label' => 'LBL_NAME','module' => 'rc_ads'), $this);?>
...
' title=''      accesskey='9'  >
	...
	<td scope="row" nowrap="nowrap" width='1%' >
		...
		<label for='current_user_only_basic' ><?php echo smarty_function_sugar_translate(array('label' => 'LBL_CURRENT_USER_FILTER','module' => 'rc_ads'), $this);?>
</label>
    	</td>
...
value="1" title='' tabindex="" <?php echo $this->_tpl_vars['checked']; ?>
 >
	...
	<td scope="row" nowrap="nowrap" width='1%' >
		...
		<label for='page_basic' ><?php echo smarty_function_sugar_translate(array('label' => 'LBL_PAGE','module' => 'rc_ads'), $this);?>
</label>
    	</td>
...
<?php echo smarty_function_html_options(array('id' => 'page_basic','name' => 'page_basic[]','options' => $this->_tpl_vars['fields']['page_basic']['options'],'size' => '6','style' => "width: 150px",'multiple' => '1','selected' => $this->_tpl_vars['fields']['page_basic']['value']), $this);?>
	...
	<td scope="row" nowrap="nowrap" width='1%' >
		...
		<label for='status_basic' ><?php echo smarty_function_sugar_translate(array('label' => 'LBL_STATUS','module' => 'rc_ads'), $this);?>
</label>
    	</td>
...
<?php echo smarty_function_html_options(array('id' => 'status_basic','name' => 'status_basic[]','options' => $this->_tpl_vars['fields']['status_basic']['options'],'size' => '6','style' => "width: 150px",'multiple' => '1','selected' => $this->_tpl_vars['fields']['status_basic']['value']), $this);?>
	...
	<td scope="row" nowrap="nowrap" width='1%' >
		...
		<label for='position_basic' ><?php echo smarty_function_sugar_translate(array('label' => 'LBL_POSITION','module' => 'rc_ads'), $this);?>
</label>
    	</td>
...
<?php echo smarty_function_html_options(array('id' => 'position_basic','name' => 'position_basic[]','options' => $this->_tpl_vars['fields']['position_basic']['options'],'size' => '6','style' => "width: 150px",'multiple' => '1','selected' => $this->_tpl_vars['fields']['position_basic']['value']), $this);?>
